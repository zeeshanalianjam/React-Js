...
const TeamCard = ({username , team , secondName , thirdName}) => {
    ...
    <div className="grid grid-cols-1 gap-[30px] md:grid-cols-3">
      ...
      <div className="flex flex-col items-center text-start">
        ...
        >
          ...
          />
          <div className="absolute bottom-4 left-4">
            <h1 className="text-xl font-semibold text-white">{secondName}</h1>
      ...
      <div className="flex flex-col items-center text-start">
        ...
        >
          ...
          />
          <div className="absolute bottom-4 left-4">
            <h1 className="text-xl font-semibold text-white">{thirdName}</h1>
